...
<div id="product-grid">
    ...
    $product_array = $db_handle->runQuery("SELECT nProduit AS code, nomProduit AS name, qteStock AS quantity, prixProduit AS price, descProduit AS image FROM Produit WHERE nomProduit LIKE '%$chercherUnProduit%'");
